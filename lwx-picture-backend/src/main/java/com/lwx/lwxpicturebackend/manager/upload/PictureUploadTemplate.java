package com.lwx.lwxpicturebackend.manager.upload;
...
import com.lwx.lwxpicturebackend.config.CosClientConfig;
...
public abstract class PictureUploadTemplate {
    ...
    public final UploadPictureResult uploadPicture(Object inputSource, String uploadPathPrefix) {
        ...
        String suffix = FileUtil.getSuffix(originFilename);  // 获取文件后缀
        String fileSuffix = (StringUtils.isEmpty(suffix)) ? "jpg" : suffix;  // 若没有后缀，则默认为jpg
