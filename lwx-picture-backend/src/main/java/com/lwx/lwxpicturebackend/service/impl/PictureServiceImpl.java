package com.lwx.lwxpicturebackend.service.impl;
...
import com.lwx.lwxpicturebackend.api.aliyunai.AliYunAiApi;
import com.lwx.lwxpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.lwx.lwxpicturebackend.exception.ThrowUtils;

import com.lwx.lwxpicturebackend.manager.CosManager;
import com.lwx.lwxpicturebackend.manager.upload.FilePictureUpload;
import com.lwx.lwxpicturebackend.manager.upload.UrlPictureUpload;
import com.lwx.lwxpicturebackend.model.dto.file.UploadPictureResult;
...
import com.lwx.lwxpicturebackend.model.enums.PictureReviewStatusEnum;
import com.lwx.lwxpicturebackend.model.vo.PictureVO;

import com.lwx.lwxpicturebackend.model.vo.UserVO;
import com.lwx.lwxpicturebackend.service.PictureService;
import com.lwx.lwxpicturebackend.mapper.PictureMapper;
import com.lwx.lwxpicturebackend.service.SpaceService;
import com.lwx.lwxpicturebackend.service.UserService;
import com.lwx.lwxpicturebackend.utils.ColorSimilarUtils;
...
//            }
            if(spaceId==null){
                //如果传入的空间id为空，就与原来的空间id保持一致
                    spaceId=oldPicture.getSpaceId();
            }else{
                //如果传入的空间id为不为，判断是否与原来的空间id保持一致
...
// 异步清理文件
    ...
    public List<PictureVO> searchPictureByColor(Long spaceId, String color, User loginUser) {
        ...
        if(!loginUser.getId().equals(space.getUserId())){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"空间权限不足");
        }
        // 3. 查询该空间下所有图片（必须有主色调）
